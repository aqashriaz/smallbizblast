			  ...
			  <?php } else{ ?>  
                  ...
                  <ul class="list-unstyled components  mt-5 header2 navi">
				   ...
				   <li class="nav-item">
                     ...
                     <?php echo anchor('Admin/business_new_deal?id='. $_SESSION['businessid'], '<span class="fa fa-user mr-3"></span> Add New Deals', 'id="$row->id"'); ?>  

				    </li>
			     	<li class="nav-item">
					                     
                      <?php echo anchor('Admin/business_deal_list?id='. $_SESSION['businessid'], '<span class="fa fa-calendar mr-3"></span> View Deal List', 'id="$row->id"'); ?>  
			    	...
			    	<li class="nav-item">
                      ...
                      <?php echo anchor('Admin/business_metrics?id='. $_SESSION['businessid'], '<span class="fa fa-cogs mr-3"></span> Metrics', 'id="$row->id"'); ?>      
