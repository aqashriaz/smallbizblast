		...
		<nav id="sidebar" class="order-last img rightsidebar1">
			...
			<div class="mt-5">
				...
				<ul class="list-unstyled components  mt-3 header2 navi">
					...
					<li>
						<a href="<?php echo base_url()?>/Admin/add_business"><span class="fa fa-calendar mr-3"></span> Add New Businesses</a>
					</li>
					<li>
						<a href="<?php echo base_url()?>/Admin/com_view_business"><span class="fa fa-calendar mr-3"></span> View Businesses</a>
					</li>
					<li>
						<a href="<?php echo base_url()?>/Admin/com_prefrences"><span class="fa fa-bar-chart mr-3"></span>SmallBizBlast Preferences</a>
					</li>
					<li>
						<a href="<?php echo base_url()?>/Admin/com_business_signup"><span class="fa fa-user mr-3"></span> Business SignUp Preferences</a>
					</li>
					<li>
						<a href="<?php echo base_url()?>/Admin/com_infoblast"><span class="fa fa-tasks mr-3"></span> InfoBlast</a>
					</li>
					<li>
						<a href="<?php echo base_url()?>/Admin/com_metrics"><span class="fa fa-cogs mr-3"></span> Metrics</a>
					</li>
						</li>
						<li>
