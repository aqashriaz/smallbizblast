          ...
          <div class="body-content">
            ...
            <div class="global-header">
              ...
              <div class="sbo-header-inner" >
                <a class="logo shopsmall-icon" href="<?php echo base_url() ?>/Front/index" title="Link to Homepage"><img src="<?php echo base_url()?>assets/images/smallbizblast-logo-main-web.png" alt="smallbizblast">
                </a>          
...
<div class="container mt-5">
  <p class="pb_og15 text-center mt-5">You have successfully applied for your business to participate in the <?php echo $slug->community_name; ?>  SmallBizBlast program.  Please allow 1-2 business days for review of your application.</p>


<a href="<?php echo base_url()?>/<?php echo $slug->slug; ?>" title="">
  <p class="pb_og15 text-center">
Click HERE to return to the Community Deals page.
